...
VERSION = 1.0
LIBNAME = libtadahdtnumeric.so.$(VERSION)
LIBALIAS = libtadahdtnumeric.so
...
install:
	...
	echo -e "tada_hdt_numeric lib is installed"
	$(MAKE) clean
